...
from model.embedding import EmbeddingVectorizer, FastTextEmbeddingBag, ModelVectorizer, GensimVectorizer
from model.loss import AccuracyMetric, RocAucMetric
from model.siames import Siames, Matcher
from utils.loader import MentionsLoader, EmbeddingMentionLoader, WikiLinksReader, SimpleReader
...
parser = argparse.ArgumentParser(description='Train CDSSM model 4 Tele2Hack')
...
vectorizer = EmbeddingVectorizer(GensimVectorizer(model_path=args.emb_path))

batch_reader_train = SimpleReader(
...
batch_reader_test = SimpleReader(
